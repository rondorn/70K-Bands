...
class DetailViewController: UIViewController, UITextViewDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        if (bandName != nil && bandName.isEmpty == false && bandName != "None") {
            ...
            // UIDevice.orientationDidChangeNotification unavailable in visionOS - removed
    ...
    func showBandDetails(){
        ...
        // statusBarOrientation unavailable in visionOS - simplified condition
        if (UIDevice.current.userInterfaceIdiom == .pad){
    ...
    @objc func rotationChecking(){
        ...
        // statusBarOrientation unavailable in visionOS - simplified logic
        // if(UIApplication.shared.statusBarOrientation  == .landscapeLeft || UIApplication.shared.statusBarOrientation  == .landscapeRight){
        
        // For visionOS, we'll use a simplified approach based on device type
