...
func showAlert (_ message: String, title:String){
    ...
    // Note: This function needs to be called from a view controller context
    print("Alert: \(title) - \(message)")
    
    // For visionOS compatibility, this should be implemented in the calling view controller
    // using UIAlertController instead of UIAlertView
}
