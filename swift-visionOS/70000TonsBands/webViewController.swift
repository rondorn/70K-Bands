...
class WebViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let navController = self.navigationController {
            // .blackTranslucent unavailable in visionOS - using .default instead
        ...
        // .gray unavailable in visionOS - using .medium instead
    ...
    // UIWebView methods removed for visionOS compatibility - using WKWebView instead
