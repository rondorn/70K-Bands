...
class AlertPreferenesController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        // UIScreen.main unavailable in visionOS - using view bounds instead
    ...
    @IBAction func MinBeforeAlertAction() {
        ...
        if (minBeforeAlertTemp >= 0 && minBeforeAlertTemp <= 60){
            ...
            // UIAlertView removed for visionOS compatibility - replaced with UIAlertController
            let alertController = UIAlertController(title: "Number Provided Is Invalid", 
                                                 message: "Number Provided \(minBeforeAlertTemp) is Invalid\nMust be a value between 0 and 60", 
                                                 preferredStyle: .alert)
            let okAction = UIAlertAction(title: okPrompt, style: .default, handler: nil)
