...
public class LandscapeScheduleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Note: For Play Console "edge-to-edge deprecated" warning, upgrade to AGP 8.9.1+ and compileSdk 36, then use WindowCompat.enableEdgeToEdge(getWindow()) with androidx.core:core:1.17.0
